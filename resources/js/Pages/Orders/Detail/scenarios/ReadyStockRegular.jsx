...
export default function ReadyStockRegular({ order }) {
  const flags = useOrderScenario(order);
  const {
    isCargo, isPaid, orderCancelled,
    needsShippingCost, showWaitingPayment, showPaymentAction,
    showCourierSelection, showPaymentInstructionCard,
